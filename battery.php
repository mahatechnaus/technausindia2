...
<!-- <div class="container"> -->
<div class="technaus-testimonial technaus-after-overlay py-4 py-lg-6 half-width-testimonial bg-rules">
    <div class="container z-index position-relative">
        <div class="row">
            <div class="col-12 col-md-6">
                <!-- <p class="white-color font-25 mb-2">See what</p> -->
                <h2 class="technaus-third-text-color font-35 font-weight-bold">
                    Solar Battery <span class="white-color">
                        Storage</span></h2>
...
<div class="container py-3">
    <div class="technaus-Testimonials my-3">   
