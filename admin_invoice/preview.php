            ...
            <table width="90%" height="92" cellpadding="10px" cellspacing="0" align="center" style="margin-top: -20px;">
                ...
                <tr>
                    ...
                    <td width="57%">
                        ...
                        echo "Bill To <br><strong>" . $row_b["company_name"] . "</strong><br>" . $row_b["address"] . "<br>";
                    ...
                    <td width="33%">
                        <!-- <p style="text-decoration: underline;">Original For Recipient</p> -->
                        <?php
                        $formattedDate = date("d/m/Y", strtotime($date));
                        echo "Invoice Date: " . $formattedDate . "<br>";


                        echo "Terms: Due on Receipt <br>";
                        ...
                        echo "Due Date : " . $formattedDate . "<br>";
