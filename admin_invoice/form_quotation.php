                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select name="cust_state" id="cust_state" class="form-control" required>
                                                    ...
                                                    <option value="RCC">Puducherry</option>
                                                    <option value="Flat Roof">Tamil nadu</option>
                                                    <option value="Flat Roof">Andhra Pradesh</option>
                                                    <option value="Flat Roof">Kerala</option>
                                                    <option value="Flat Roof">Karnataka</option>
                            ...
                            <div class="card text-dark bg-light mb-1">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label>Consumer / Meter No.</label><br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="distributor_name" id="distributor_name"
                                                    ...
                                                    <option value="Electricity Department - Puducherry">Electricity
                                                        Department -
                                                        Puducherry</option>
                                                    <option value="Tamil nadu Electricity Board - TN">Tamil nadu
                                                        Electricity
                                                        Board - TN</option>
                                                    <option value="Others">Others</option>
                                                </select>
                            ...
                            <div class="card text-white bg-secondary  mb-1">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label>Panel Brand</label><br>
                                                <!-- <input type="text" id="panel_brand" name="panel_brand"
                                                    class="form-control" placeholder="Panel Brand" required> -->
                                        ...
                                        <div class="col-2">
                                            <div class="form-group">
                                                <label>Panel Watts</label><br>
                                                <!-- <input type="text" id="panel_model" name="panel_model"
                                                    class="form-control" placeholder="Panel Model" required> -->
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label>Inverter Brand</label><br>
                                                <!-- <input type="text" id="inverter_brand" name="inverter_brand"
                                                    class="form-control" placeholder="Inverter Brand" required> -->
                                        ...
                                        <div class="col-2">
                                            <div class="form-group">
                                                <label>Inverter KW</label><br>
                                                <input type="text" id="no_inverter_kw" name="no_inverter_kw"
                                                    class="form-control" placeholder="Inverter KW" required>

                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="form-group">
                                                <label>No. of Inverter</label><br>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="battery_capacity" name="battery_capacity"
                                                    class="form-control" placeholder="Battery Capacity" required>
                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="form-group">
                                                <label>No. of Battery</label><br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label> Payment Plan Option Chosen</label><br>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="actual_amt" name="actual_amt"
                                                    class="form-control" placeholder="Actual Total Amount">
