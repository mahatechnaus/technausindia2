<body>
    ...
    <div class="technaus-transparent py-3 py-lg-0">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12 pr-md-0">
                    ...
                    <nav class="navbar  navbar-expand-md btco-hover-menu py-lg-2 ">
                        ...
                        <button class="navbar-toggler" type="button" data-toggle="collapse"
                            data-target="#technausNavDropdown" aria-controls="technausNavDropdown" aria-expanded="false"
                        ...
                        <div class="collapse navbar-collapse justify-content-end " id="technausNavDropdown">
                            <ul class="navbar-nav mx-auto technaus-nav">
                                <a class="nav-link" href="index" id="home">
                                    Home
                                </a>
