...
$page_title = "Contact Us - Solar in Puducherry - Get in Touch for Solar Solutions";
        ...
        <div class="col-12 col-md-10 offset-md-1 mt-5">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-4 text-center mb-5 mb-md-0 wow fadeInDown" data-wow-delay=".8s">
                    ...
                    <!-- Add the email link here -->
                    <p class="font-14 technaus-main-text-color text-center">
                        <a href="mailto:solar@technaus.co.in" class="technaus-main-text-color">solar@technaus.co.in</a>
                    </p>
                    ...
                    <h2 class="font-16 semi-font technaus-second-text-color my-3">Stay In Touch</h2>
                        ...
                        <ul class="nav technaus-contact-social-links">
                            <li><a href="https://www.facebook.com/technausrenewable" target="_blank"><i
                                        class="fab fa-facebook-f  fa-fw mx-3"></i></a></li>
